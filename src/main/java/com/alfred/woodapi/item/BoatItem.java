...
public class BoatItem extends net.minecraft.item.BoatItem {
    ...
    public BoatItem(boolean chest, BoatEntity.BoatType type, Settings settings) {
    ...
    protected net.minecraft.entity.vehicle.BoatEntity createEntity(World world, HitResult hitResult, ItemStack stack, PlayerEntity player) {
        ...
        net.minecraft.entity.vehicle.BoatEntity boat = this.chest ? ChestBoatEntity.create(world, this.type, vec3d.x, vec3d.y, vec3d.z) : BoatEntity.create(world, this.type, vec3d.x, vec3d.y, vec3d.z);
